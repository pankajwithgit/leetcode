class Solution {
    public List<Integer> topKFrequent(int[] nums, int k) {
        ...
        // Build a priority queue to keep k elements. Priority queue will be ordered by smallest frequency first, so keep pushing out element to just maintain k elements only.
